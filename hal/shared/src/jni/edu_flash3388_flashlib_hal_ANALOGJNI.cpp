 ...
 * Method:    checkPortAnalogInput
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_edu_flash3388_flashlib_hal_ANALOGJNI_checkPortAnalogInput
...
/*
 * Class:     edu_flash3388_flashlib_hal_ANALOGJNI
 * Method:    checkPortAnalogOutput
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_edu_flash3388_flashlib_hal_ANALOGJNI_checkPortAnalogOutput
  (JNIEnv *env, jclass thisobj , jint port){
